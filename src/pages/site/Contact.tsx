...
export default function Contact() {
  ...
  const [form, setForm] = useState({
    name: '', phone: '', email: '', type: 'buyer', subject: '', message: '',
  });
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_400px]">
          ...
          >
            ...
            <div className="mt-8 grid gap-5 sm:grid-cols-2">
              ...
              <div>
                <label className="mb-1.5 block text-sm font-medium">Talep *</label>
                <Select
                  value={form.type}
                  onChange={(e) => setForm((f) => ({ ...f, type: e.target.value }))}
                >
                  <option value="buyer">Arsa almak istiyorum</option>
                  <option value="seller">Arsa satmak istiyorum</option>
                  <option value="invest">Yatırım danışmanlığı</option>
              ...
              <div className="sm:col-span-2">
                ...
                <Input
                  ...
                  placeholder="Örn: Temelli OSB yakını 1.000 m² arsa"
                />
              </div>
              <div className="sm:col-span-2">
                ...
                <Textarea
                  ...
                  placeholder="Bütçeniz, istediğiniz bölge, m² bilgisi, vb."
                />
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-card/40 p-5 backdrop-blur-md">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="font-display text-lg font-semibold">{COMPANY.address}</div>
                </div>
              </div>
